...
<!--
  Based on toby-plugins (MIT, © Toby Lee) — see ../SKILL.md for the full
  attribution block and the list of changes made in this port.
-->
...
- Any `cache/`, `node_modules/`, `__pycache__/`, `*.log`, `.DS_Store`, `.cache.json` inside included directories (applied globally by rsync)
